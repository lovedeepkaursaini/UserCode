...
colors = [
    ...
    (153,51,102), # kPink+3 for qcd 
    (204,102,0), # kOrange+2 for ttbar
    (153,153,51), # kYellow-2 for wjets
    (51,204,153), # kTeal-5 for zjets
    ( 0,51,153), # kAzure-6
    (145,  83, 207), # purple
    (231, 139,  77), # orange
    (114, 173, 117), # green
...
#### Legend
legend_width = 0.16 #38        # Fraction of canvas width
...
latex.DrawLatex(0.94,0.96,"CMS preliminary 2011, #sqrt{s} = 7 TeV")
#latex.SetTextAlign(11)
