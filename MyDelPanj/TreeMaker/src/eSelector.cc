...
//       std::cout<<"isoBrlX: "<< dcotBrlX_<<std::endl;
	...
	iso3 = iso3/pt;
	iso4 = iso4/pt;
        //std::cout<<"ParticleFlowIso: "<<iso4<<std::endl;
     }
	 ...
	 cuts["detain"] = fabs(e.deltaEtaSuperClusterTrackAtVtx())<detainBrlX_;
 	 ...
 	 cuts["dcot"]   = !(fabs(e.convDcot())< dcotBrlX_ && fabs(e.convDist())< distBrlX_);
         cuts["dist"]   = !(fabs(e.convDcot())< dcotBrlX_ && fabs(e.convDist())< distBrlX_);	
	 ...
	 cuts["dcot"]   = !(fabs(e.convDcot())< dcotEcpX_ && fabs(e.convDist())< distEcpX_);
         cuts["dist"]   = !(fabs(e.convDcot())< dcotEcpX_ && fabs(e.convDist())< distEcpX_);
