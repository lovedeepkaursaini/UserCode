...
{
  if (tree == 0) {
    TFile *f = TFile::Open("rfio:/castor/cern.ch/user/l/lovedeep/TRIG_Spring10/mrgd_TrigTree_MC_SPring10_357ReReco-v3.root");
...
void trigEffi::Loop(TString type)
{
   ...
   TFile * file = new TFile("EffiHisto_"+type+".root","recreate");
        
   TH1D* hEtSCAll=new TH1D("hEtSCAll","hEtSCAll",100,10,60);
   TH1D* hEtSCAllEt10=new TH1D("hEtSCAllEt10","hEtSCAllEt10",100,10,60);
   TH1D* hEtSCAllEt10HoE=new TH1D("hEtSCAllEt10HoE","hEtSCAllEt10HoE",100,10,60);
   TH1D* hEtSCAllEt10HoESihih=new TH1D("hEtSCAllEt10HoESihih","hEtSCAllEt10HoESihih",100,10,60);
   TH1D* hEtSCAllEt10HoESihihnBC=new TH1D("hEtSCAllEt10HoESihihnBC","hEtSCAllEt10HoESihihnBC",100,10,60);

   TH1D* hEtSCTrgEt10HoESihihnBC=new TH1D("hEtSCTrgEt10HoESihihnBC","hEtSCTrgEt10HoESihihnBC",100,10,60);
   TH1D* hEtSCTrg=new TH1D("hEtSCTrg","hEtSCTrg",100,10,60);
   TH1D* hEtSCTrgEt10=new TH1D("hEtSCTrgEt10","hEtSCTrgEt10",100,10,60);
   TH1D* hEtSCTrgEt10HoE=new TH1D("hEtSCTrgEt10HoE","hEtSCTrgEt10HoE",100,10,60);
   TH1D* hEtSCTrgEt10HoESihih=new TH1D("hEtSCTrgEt10HoESihih","hEtSCTrgEt10HoESihih",100,10,60);

   TH1D* hEtSCL1TrgEt10HoESihihnBC=new TH1D("hEtSCL1TrgEt10HoESihihnBC","hEtSCL1TrgEt10HoESihihnBC",100,10,60);
   TH1D* hEtSCL1Trg=new TH1D("hEtSCL1Trg","hEtSCL1Trg",100,10,60);
   TH1D* hEtSCL1TrgEt10=new TH1D("hEtSCL1TrgEt10","hEtSCL1TrgEt10",100,10,60);
   TH1D* hEtSCL1TrgEt10HoE=new TH1D("hEtSCL1TrgEt10HoE","hEtSCL1TrgEt10HoE",100,10,60);
   TH1D* hEtSCL1TrgEt10HoESihih=new TH1D("hEtSCL1TrgEt10HoESihih","hEtSCL1TrgEt10HoESihih",100,10,60);
