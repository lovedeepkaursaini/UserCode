...
ptBins = cms.PSet(
    ...
    BinnedVariables = cms.PSet(
    #probe_pt = cms.vdouble(20,30,40,50,60,70,120)
    #robe_sc_et = cms.vstring("Probe E_{T}", "0", "200", "GeV/c"),
    #probe_sc_abseta = cms.vstring("Probe |#eta|", "0.", "2.5", "")
    probe_gsfEle_et =  cms.vstring("Probe E_{T}", "0", "200", "GeV/c"),
    probe_sc_abseta = cms.vstring("Probe |#eta|", "0.", "2.5", "")
    #BinToPDFmap = cms.vstring("fittingFunction")
...
categories =  cms.PSet(probe_isWPVeto = cms.vstring("probe_passingSomething", "dummy[pass=1,fail=0]"))
...
def ConfigureTPAnalyzer (Analyzer, fileName, pred,binScheme, tree= "fitter_tree"):
    ...
    """
    Analyzer.InputFileNames = cms.vstring("/scratch/anil79/"+fileName+".root")
