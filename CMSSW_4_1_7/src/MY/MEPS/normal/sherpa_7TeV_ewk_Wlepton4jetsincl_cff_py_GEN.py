...
# with command line options: MY/MEPS/sherpa_7TeV_ewk_Wlepton4jetsincl_cff.py -s GEN --conditions START3X_V25::All --datatier GEN-SIM-RAW --eventcontent RAWSIM --customise MY/MEPS/sherpa_custom_cff.py -n 100 --no_exec --fileout outputGEN.root
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('MY/MEPS/sherpa_7TeV_ewk_Wlepton4jetsincl_cff.py nevts:100'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/scratch/kaur/MEPSnormal100k.root'),
...
process.generator = cms.EDFilter("SherpaGeneratorFilter",
    ...
    libDir = cms.untracked.string('/afs/hep.wisc.edu/user/kaur/CMSSW_4_1_7/src/MY/MEPS/normal/SherpaRun'),
