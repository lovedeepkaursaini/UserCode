...
# with command line options: MY/MENLOPS/sherpa_7TeV_ewk_Wlepton4jetsincl_scaleplus_cff.py -s GEN --conditions START41_V0::All --datatier GEN-SIM-RAW --eventcontent RAWSIM --customise MY/MENLOPS/sherpa_custom_cff.py -n 100 --no_exec --fileout outputGEN.root
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('MY/MENLOPS/sherpa_7TeV_ewk_Wlepton4jetsincl_scaleplus_cff.py nevts:100'),
...
process.generator = cms.EDFilter("SherpaGeneratorFilter",
    ...
    libDir = cms.untracked.string('/afs/hep.wisc.edu/user/kaur/CMSSW_4_1_7/src/MY/MENLOPS/scaleplus/SherpaRun'),
